...
const CustomIcon = ({
  ...
  <div className={className}>
    <Image src={src} alt='' width={24} height={24} className='w-full h-full' />
  </div>
);
...
const contactMethods: ContactMethod[] = [
  ...
  },
  {
    ...
    name: 'WhatsApp',
    description:
      'Chat directo para proyectos urgentes (lunes a viernes 9:00 AM - 5:00 PM)',
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='text-xl text-foreground/70 max-w-3xl mx-auto mb-8'>
            Trabajemos juntos en nuevos desafíos. Conversemos sobre cómo puedo
                    ...
                    return (
                      ...
                      >
                        <div className='flex items-start space-x-4'>
                          <div
                            className={`w-14 h-14 ${method.color} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                          >
              ...
              <form onSubmit={handleSubmit} className='space-y-6'>
                ...
                {submitStatus === 'error' && (
                  ...
                  >
                    ...
                    <span>
                      Error al enviar el mensaje. Intenta contactarme
                      directamente.
                    </span>
                  </motion.div>
                )}
