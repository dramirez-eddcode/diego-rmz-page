      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='text-xl text-foreground/70 max-w-3xl mx-auto'>
            Competencias técnicas y herramientas que aplico en la construcción
            de soluciones escalables y de alto rendimiento.
          </p>
        </motion.div>
        ...
        >
          <div className='relative w-80 h-80 md:w-96 md:h-96'>
            ...
            {radarData.map((item, index) => {
              const angle =
                (index / radarData.length) * 2 * Math.PI - Math.PI / 2;
              ...
              return (
                ...
                >
                  <div
                    className={`w-4 h-4 ${item.color} rounded-full shadow-lg hover:scale-125 transition-transform border-2 border-foreground/80`}
                  />
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto'>
            {learningSkills.map((skill, index) => (
              ...
              >
                ...
                <h4 className='font-bold text-foreground mb-3'>{skill.name}</h4>
